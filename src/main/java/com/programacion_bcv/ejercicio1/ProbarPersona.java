...
public class ProbarPersona {
        public static void main(String[] args) {
                ...
                System.out.println("El signo de " + p1.getNombre() + " " + p1.getApellido() + " es " + p1.getSigno());

                Persona p2 = new Persona("Esteban", "Suarez", 45679034, LocalDate.now());
                System.out.println("El signo de " + p2.getNombre() + " " + p2.getApellido() + " es " + p2.getSigno());

                Persona p3 = new Persona("Luis", "Gonzalez", 30987123, LocalDate.of(1969, 2, 11));
                System.out.println("El signo de " + p3.getNombre() + " " + p3.getApellido() + " es " + p3.getSigno());
